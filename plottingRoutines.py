...
rainbow = ['#e61b23', '#f8a20e', '#00a650', '#1671c2', '#282b80']
...
# Colourmaps.
whblbk = sns.cubehelix_palette(light=1., dark=0.2, start=0.1, hue=1.0, 
                               rot=-0.3, as_cmap=True) 
bkblwh = sns.cubehelix_palette(light=1., dark=0.2, start=0.1, hue=1.0, 
